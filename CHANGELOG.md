...
- Typer-based `grok-build-bridge` CLI entrypoint.
- Package skeleton: `parser`, `xai_client`, `builder`, `safety`, `runtime`, `deploy`.
- JSON schema stub at `grok_build_bridge/schema/bridge.schema.json`.
- Apache-2.0 license, GitHub Actions CI skeleton, and contributor docs.
